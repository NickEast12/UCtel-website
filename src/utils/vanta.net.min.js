!(function (t, e) {
  ...
  return (function (t) {
    ...
    0(t, e, i) {
      ...
      const c = (t) =>
        typeof t === 'number' ? `#${`00000${t.toString(16)}`.slice(-6)}` : t;
      const l = (t, e = 1) => {
        const i = c(t);
      ...
      const u = (t) => 0.299 * t.r + 0.587 * t.g + 0.114 * t.b;
    },
    1(t, e, i) {
      i.d(e, 'a', function () {
        return r;
      ...
      (r.VantaBase = class {
        constructor(t = {}) {
          ...
          if (
            ...
            (t instanceof HTMLElement || typeof t === 'string') &&
              (t = { el: t }),
        ...
        prepareEl() {
          ...
          for (t = 0; t < this.el.children.length; t++)
            (e = this.el.children[t]),
              ...
              getComputedStyle(e).zIndex === 'auto' && (e.style.zIndex = 1);
      ...
      class r extends s.b {
        ...
        genPoint(t, e, i) {
          ...
          if ((this.points || (this.points = []), this.options.showDots)) {
            ...
            const e = new n.MeshLambertMaterial({ color: this.options.color });
            s = new n.Mesh(t, e);
        ...
        onInit() {
          ...
          const r = Object(o.d)(new n.Color(this.options.backgroundColor));
          ...
          const a = new n.LineBasicMaterial({
            ...
            blending: this.blending === 'additive' ? n.AdditiveBlending : null,
            transparent: !0,
          });
          ...
          for (let i = 0; i <= t; i++)
            for (let s = 0; s <= t; s++) {
              ...
              const r = (i - t / 2) * e + Object(o.g)(-5, 5);
        ...
        onUpdate() {
          let t;
          this.helper != null && this.helper.update(),
          ...
          const h = new n.Color(this.options.color);
          const a = h.clone().sub(r);
          this.rayCaster &&
          ...
          for (let t = 0; t < this.points.length; t++) {
            ...
            const u = (c = this.rayCaster
              ? this.rayCaster.ray.distanceToPoint(l.position)
              : 1e3).clamp(5, 15);
            if (
              ((l.scale.x = l.scale.y = l.scale.z = (0.25 * (15 - u)).clamp(
                1,
                100
              )),
              l.r !== 0)
            ...
            for (let c = t; c < this.points.length; c++) {
              ...
              const u = l.position.x - t.position.x;
              const p = l.position.y - t.position.y;
              const d = l.position.z - t.position.z;
              if (
        ...
        onMouseMove(t, e) {
          ...
          const o = Math.sqrt(i.oz * i.oz + i.ox * i.ox);
          const n = s + 2 * (t - 0.5) * (this.options.mouseCoeffX || 1);
          (i.tz = o * Math.sin(n)),
            (i.tx = o * Math.cos(n)),
